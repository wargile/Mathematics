function [curve_data] = murf_envelope_test(pot_pos, max_interval)
...
%   See also MURF, MURF_ENVELOPE.
	...
	%difference = ((sqrt(max_interval) - curve_min) / ...
    %    (max_interval / 2)) * -1;
	%curve_min = 1.41421356237310;
    % Don't go below this value for rise/fall curve
